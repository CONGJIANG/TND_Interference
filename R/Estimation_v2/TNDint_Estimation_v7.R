...
file_path<-paste0("estimand_GLMM_nclock_1000_rangeN_1000_1200_M_1000")

save(estimands_list, file=file_path)

load("estimand_GLMM_nclock_1000_rangeN_1000_1200_M_1000")
...
file_path<-paste0("truth_fin_res_estimand_GLMM_nclock_1000_rangeN_1000_1200_M_1000")
